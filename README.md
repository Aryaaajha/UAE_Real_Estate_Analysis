# 🏙️ UAE Real Estate Rental Analysis

## 📌 Project Summary
This project analyzes **73,000+ rental listings** across the UAE to understand what drives property prices in the region. Using Python, I processed raw real estate data to identify which cities are the most expensive, which areas have the most supply, and how factors like "Furnishing" and "Property Type" affect the annual rent.

## 🚀 Key Insights & Results
* **Market Leader:** **Dubai** dominates the rental market with **33,000 listings**, making up nearly **45% of the total data**, followed by Abu Dhabi.
...
* **Most Popular Choice:** **Apartments** are the most common listing (56k+), and **Unfurnished** units make up **78% of the market**, suggesting that most tenants prefer to bring their own furniture to save on monthly costs.
  ...
  ![Dashboad](visualization/dashboard.JPG)
